//====================================================================================================================================================
// CS5413 : pgm1 - problem I written by Ali Alsahlanee, Fadhil  (PART 3) All in One Graphs
// Semester : Fall 2019
// Prof. N.Park
...
// adding/removing some of the users/groups/attributes by giving some permissions
// All in one graphs, dual permissions and trusted/untrusted IDs with all users and groups
//=====================================================================================================================================================
import java.util.*;
import java.io.*;
@SuppressWarnings("unchecked")
public class AllGraphIDs3 {
    ...
    public static void main(String[] args)throws Exception {
	   ...
	   ArrayList<String> PrivNodeGraphyGroup = new ArrayList<String>(100);// this Arraylist fro holding the groups nodes
		...
		PrivNodeGraphyGroup.add("10");
			...
			System.out.println("=====================================");
			System.out.println();
			System.out.print("Add a USER/GROUP (Permitted): ");
			String qq = scinputes.nextLine();
			PrivNodeGraphyUser.add(qq);
			PrivNodeGraphyGroup.add(qq);
			System.out.print("Remove a USER/GROUP (Not Permitted): ");
			String pp = scinputes.nextLine();
			PrivNodeGraphyUser.remove(pp);
			PrivNodeGraphyGroup.remove(pp);
		...
		System.out.println();
			...
			System.out.println("Opps! can not apply, trusted(USER/GROUP)Edges! Try again!");
		}
    }
